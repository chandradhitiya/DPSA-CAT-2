"""
Flask frontend for the PPML / DP comparison project.

Run from repo root:
  export FLASK_APP=claude.app
...
# Ensure sibling imports (preprocess, etc.) resolve when running as module
_CLAUDE = os.path.dirname(os.path.abspath(__file__))
...
app = Flask(
    __name__,
    template_folder=os.path.join(_CLAUDE, "templates"),
    static_folder=os.path.join(_CLAUDE, "static"),
)
app.secret_key = os.environ.get("FLASK_SECRET_KEY", "dev-ppml-key-change-in-production")
